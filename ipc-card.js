...
registerFont("alagard.ttf", { family: "alagard" });

const IPCCARD_DIR = "cards/";
...
async function ipccard_store(ipc)
{
    ...
    let card = await loadImage("ipc-card-template.png")
        .catch(err => null);
    if (card == null) return "";
    ...
    context.fillText("IPC #" + ipc.token_id + " " + label_ipc.race, 170, 80);
